...
// API configuration
const API_KEY = "YOUR_GEMINI_API_KEY"; // Your API key here
...
const showLoadingAnimation = () => {
  const html = `<div class="message-content">
                  <img class="avatar" src="./image.png" alt="Gemini avatar">
                  <p class="text"></p>
...
const resetChat = () => {
  if (confirm("Are you sure you want to reset the chat?")) {
    ...
    // Clear the saved chats from local storage
    localStorage.removeItem("saved-chats");

    // Optionally, you can reset other state variables if needed
    userMessage = null;
    isResponseGenerating = false;
